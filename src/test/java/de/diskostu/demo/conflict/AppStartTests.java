 ...
 * . Therefore, I renamed the method {@code item1()} in {@link TestConflictConfig} to {@code testItem1()}</p>. Now, the
 * autowired bean {@code item1} can be properly resolved. I also added a second autowired field for the test bean.
 */
